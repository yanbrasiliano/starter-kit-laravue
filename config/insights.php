...
use NunoMaduro\PhpInsights\Domain\Insights\{ForbiddenDefineFunctions, ForbiddenFinalClasses, ForbiddenNormalClasses, ForbiddenPrivateMethods, ForbiddenTraits};
use NunoMaduro\PhpInsights\Domain\Metrics\Architecture\Classes;
use SlevomatCodingStandard\Sniffs\Commenting\UselessFunctionDocCommentSniff;
use SlevomatCodingStandard\Sniffs\Namespaces\AlphabeticallySortedUsesSniff;
use SlevomatCodingStandard\Sniffs\TypeHints\{DeclareStrictTypesSniff, DisallowMixedTypeHintSniff, ParameterTypeHintSniff, PropertyTypeHintSniff, ReturnTypeHintSniff};
